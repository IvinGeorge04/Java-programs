...
public class CustomBank2 {
	...
	public static void main(String[] args) {
		...
		int n=sc.nextInt();
		sc.nextLine();
		MyCustomBank2[] b=new MyCustomBank2[n];
		for(int i=0;i<n;i++) {
			b[i]=new MyCustomBank2();
			System.out.println("Enter the Acount "+(i+1)+" Details: ");
			b[i].OpenAccount();
			
			System.out.println();
		}
		do {
			System.out.println("\n****Bankiing System Application****");
